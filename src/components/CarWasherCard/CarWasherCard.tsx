...
import { CarWasherCardProps } from './types'
import * as styles from './styles'

const CarWasherCard = (props: CarWasherCardProps) => {
    const heartProps: HeartProps = useMemo(() => ({
        liked: props.isLiked!,
        toggleLiked: props.toggleLiked,
    }), [props.isLiked, props.toggleLiked])

    return (
        <styles.Card onClick={ props.onClick }>
            <styles.Row>
                <styles.Title>
                    { props.name }
                </styles.Title>
                { props.isLiked !== undefined && <HeartIcon { ...heartProps } /> }
            </styles.Row>
            <styles.Row>
                <styles.Text>
            ...
            <styles.Row style={ { marginTop: '.8em', alignItems: 'flex-end' } }>
                <styles.Row style={ { justifyContent: 'flex-start' } }>
                    <Avatar sx={ { width: 64, height: 64 } } src={ props.photo[0] } alt="logo"/>
                    <styles.Column style={ { marginLeft: '1em', height: '64px' } }>
                        ...
                        <styles.AdditionalInfo>
                            ...
                            <styles.IconWithText style={ { marginLeft: '1em' } }>
                ...
                <Price showPerHour={ true } amount={ props.price }/>
            </styles.Row>
        </styles.Card>
    )
}
